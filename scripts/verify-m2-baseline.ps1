...
Write-Host '[m2-baseline] tip: for §7 JSON + section-9-summary.generated.md, set SERVICE_ROUTER_ACCEPTANCE_RUN_GLOBAL=0 and run docs/release-acceptance.ps1 (see docs/m2-release-readiness.md#m2-json-bundle-s9)'