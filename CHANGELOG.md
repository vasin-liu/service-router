...
- **Release workflow**: `.github/workflows/release.yml` builds cross-platform binaries (Linux x86_64, Windows x86_64, macOS x86_64/aarch64) on tag push and creates a GitHub Release with artifacts.
- **Getting Started guide**: `docs/getting-started.md` — end-to-end tutorial from `init` to first proxied request with follow-up scenarios (local override, CI smoke, config diff).
